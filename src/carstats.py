...
class CarType:
    ...
    cars = {"Green Car": CarStats(image="src/files/green_car.png", drift_angle=1.108, coin_req=0, frag_req=0, lvl_req=0,
                                  health=0, health_regen=0, mana=0, mana_regen=0, rarity="COMMON", ability=None),
            "Yellow Car": CarStats(image="src/files/yellow_car.png", drift_angle=1.14, coin_req=25, frag_req=0, lvl_req=2,
                                   health=5, health_regen=2, mana=4, mana_regen=2, rarity="COMMON", ability=None),
            "Blue Car": CarStats(image="src/files/blue_car.png", drift_angle=1.19, coin_req=60, frag_req=0, lvl_req=4,
                                 health=20, health_regen=5, mana=9, mana_regen=5, rarity="UNCOMMON", ability=None),
            "Black Car": CarStats(image="src/files/black_car.png", drift_angle=1.28, coin_req=120, frag_req=0, lvl_req=7,
                                  health=40, health_regen=8, mana=14, mana_regen=8, rarity="UNCOMMON", ability=None),
            "Taxi": CarStats(image="src/files/taxi.png", drift_angle=1.35, coin_req=185, frag_req=0, lvl_req=11,
                             health=70, health_regen=14, mana=21, mana_regen=14, rarity="UNCOMMON", ability=None),
            "Police Car": CarStats(image="src/files/police_car.png", drift_angle=1.45, coin_req=350, frag_req=0, lvl_req=14,
                                   health=110, health_regen=20, mana=36, mana_regen=20, rarity="RARE", ability=None),
            "Ambulance": CarStats(image="src/files/ambulance.png", drift_angle=1.55, coin_req=550, frag_req=0, lvl_req=19,
                                  health=160, health_regen=26, mana=50, mana_regen=26, rarity="RARE", ability=None),
            "Fire Truck": CarStats(image="src/files/fire_truck.png", drift_angle=1.7, coin_req=750, frag_req=0, lvl_req=23,
                                   health=220, health_regen=32, mana=65, mana_regen=32, rarity="RARE", ability=None),
            "Bus": CarStats(image="src/files/bus.png", drift_angle=1.9, coin_req=1000, frag_req=0, lvl_req=28,
                            health=300, health_regen=40, mana=84, mana_regen=40, rarity="EPIC", ability=None),
            "Race Car": CarStats(image="src/files/racecar.png", drift_angle=2.1, coin_req=1300, frag_req=0, lvl_req=33,
                                 health=380, health_regen=55, mana=105, mana_regen=55, rarity="EPIC", ability=None),
            "Spaceship": CarStats(image="src/files/spaceship.png", drift_angle=1.3, coin_req=1650, frag_req=0, lvl_req=38,
                                  health=400, health_regen=60, mana=150, mana_regen=60, rarity="EPIC", ability=None),
            "Drifter": CarStats(image="src/files/the_drifter.png", drift_angle=2.1, coin_req=2400, frag_req=2,
                                lvl_req=43,
                                health=580, health_regen=80, mana=150, mana_regen=80, rarity="LEGENDARY",
                                ability="drifter"),
            "Timewarp": CarStats(image="src/files/timewarp.png", drift_angle=1.6, coin_req=4000, frag_req=5, lvl_req=48,
                                 health=500, health_regen=70, mana=190, mana_regen=70, rarity="LEGENDARY",
                                 ability="timewarp"),
            "Fortunate": CarStats(image="src/files/fortunate.png", drift_angle=2.2, coin_req=8000, frag_req=9, lvl_req=53,
                                  health=580, health_regen=80, mana=150, mana_regen=80, rarity="LEGENDARY",
                                  ability="fortunate"),
            "Midas' Car": CarStats(image="src/files/midas_car.png", drift_angle=2.2, coin_req=14000, frag_req=15,
                                   lvl_req=60,
                                   health=580, health_regen=80, mana=150, mana_regen=80, rarity="LEGENDARY",
                                   ability="midas car")}
